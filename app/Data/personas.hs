...
p5 = ["5","Débora","Feminino","Louro","Negra","Verdes","Chapéu"]
p6 = ["6","Paulo","Masculino","Louro","Indígena","Pretos","Óculos"]
p7 = ["7","Tatiana","Feminino","Ruivo","Indígena","Azuis","Piercing"]
p8 = ["8","Clóvis","Masculino","Ruivo","Branca","Castanhos","Brinco"]
p9 = ["9","Fátima","Feminino","Preto","Parda","Castanhos","Piercing"]
p10 = ["10","Diego","Masculino","Preto","Indígena","Azuis","Brinco"]
p11 = ["11","Cecília","Feminino","Castanho","Branca","Verdes","Óculos"]
p12 = ["12","Felipe","Masculino","Castanho","Negra","Pretos","Chapéu"]
p13 = ["13","Alessandra","Feminino","Louro","Branca","Azuis","Brinco"]
p14 = ["14","João","Masculino","Louro","Parda","Castanhos","Piercing"]
